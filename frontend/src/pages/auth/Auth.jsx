...
import ArrowDownScroll from "@/components/ArrowDownScroll";
...
const Auth = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row">
        ...
        <div className="z-10 space-y-6 text-center text-white">
          <div className="absolute top-12 left-1/2 -translate-x-1/2">
            <img
              src={logo}
              alt="Auth Image"
              className="h-56 w-64 drop-shadow-lg"
            />
          </div>
      ...
      <div
        id="auth-section"
        className="bg-card flex flex-col items-center lg:pt-20 space-y-10 px-6 py-8 lg:flex-1"
      >
